<%@ Page Title="" Language="C#" MasterPageFile="~/majori_6.Master" AutoEventWireup="true" CodeBehind="Shop-details.aspx.cs" Inherits="SHRJ.Shop_details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%-- <link href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css" rel="stylesheet" />
    ...
    <style>
.slick-carousel { display:block !important; }
</style>
                ...
                <div id="title" class="page-title">
                    <div class="section-container">
                        ...
                        <%--<div class="breadcrumbs">
									  <a href="default.aspx">Home</a><span class="delimiter"></span>
                            <a href="shop.aspx">Shop</a><%--<span class="delimiter"></span>
                            <span id="breadcrumbCategory" runat="server" class="delimiter"></span>
								</div>--%>
                        <div class="breadcrumbs">
																...
																<div class="image-thumbnail slick-carousel slick-vertical" data-asnavfor=".image-additional" data-centermode="true" data-focusonselect="true" data-columns4="5" data-columns3="4" data-columns2="4" data-columns1="4" data-columns="4" data-nav="true" data-vertical="&quot;true&quot;" data-verticalswiping="&quot;true&quot;">
																	<%--<div class="img-item slick-slide">
																		<span class="img-thumbnail-scroll">
																			<img width="600" height="600" src="Content/media/product/1.jpg" alt="">
																		</span>
																	</div>
																	<div class="img-item slick-slide">
																		<span class="img-thumbnail-scroll">
																			<img width="600" height="600" src="Content/media/product/1-2.jpg" alt="">
																		</span>
																	</div>
																	<div class="img-item slick-slide">
																		<span class="img-thumbnail-scroll">
																			<img width="600" height="600" src="Content/media/product/2.jpg" alt="">
																		</span>
																	</div>
																	<div class="img-item slick-slide">
																		<span class="img-thumbnail-scroll">
																			<img width="600" height="600" src="Content/media/product/2-2.jpg" alt="">
																		</span>
																	</div>
																	<div class="img-item slick-slide">
																		<span class="img-thumbnail-scroll">
																			<img width="600" height="600" src="Content/media/product/3.jpg" alt="">
																		</span>
																	</div>--%>
																</div>
															</div>
														...
														<div class="col-md-10">
															<div class="scroll-image main-image">
																<div class="image-additional slick-carousel" data-asnavfor=".image-thumbnail" data-fade="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
																	<%--<div class="img-item slick-slide">
																		<img width="900" height="900" src="Content/media/product/1.jpg" alt="" >
																	</div>
																	<div class="img-item slick-slide">
																		<img width="900" height="900" src="Content/media/product/1-2.jpg" alt="" >
                                                                        <img src="Content/media/product/1-2.jpg" />
																	</div>
																	<div class="img-item slick-slide">
																		<img width="900" height="900" src="Content/media/product/2.jpg" alt="" >
																	</div>
																	<div class="img-item slick-slide">
																		<img width="900" height="900" src="Content/media/product/2-2.jpg" alt="" title="">
																	</div>
																	<div class="img-item slick-slide">
																		<img width="900" height="900" src="Content/media/product/3.jpg" alt="" title="">
																	</div>--%>
																</div>
															</div>
														</div>
...
<td class="attributes">
    <%--<span><%= GetMetalDisplay(dr["MetalFull"]?.ToString()) %></span>--%>
</td>
                                    ...
                                    <div class="product-tabs-wrap">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="reviews1" role="tabpanel">
                                                <div id="reviews2" class="product-reviews">
                                                    <div id="comments">
    ...
    <%--<script>
        $(document).ready(function(){
            ...
            $('.plus').click(function(){ 
                var qty = parseInt($('#<%=txtQuantity.ClientID%>').val()) + 1;
                $('#<%=txtQuantity.ClientID%>').val(qty);
            });
            $('.minus').click(function(){
                var qty = parseInt($('#<%=txtQuantity.ClientID%>').val()) - 1;
                if(qty > 0) $('#<%=txtQuantity.ClientID%>').val(qty);
            });
        });
    </script>--%>
<script src="Content/libs/popper/js/popper.min.js"></script>
    ...
    $(window).on('load', function () {
        ...
        if ($('.image-thumbnail-scroll').hasClass('slick-initialized')) {
            $('.image-thumbnail-scroll').slick('unslick');
        }
